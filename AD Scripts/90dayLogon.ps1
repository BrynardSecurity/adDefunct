...
Get-ADUser -Properties SamAccountName,lastLogonDate -Filter {(lastLogonDate -lt $last90Days) -and (enabled -eq 'True')} | Select-Object SamAccountName,lastLogonDate | Export-CSV 'C:\Users\chris.smith\Documents\Sec\AD Reports\07-09-2015-LogOn.csv' -NoTypeInformation -Encoding UTF8